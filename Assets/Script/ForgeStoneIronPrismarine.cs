...
public class ForgeStoneIronPrismarine : MonoBehaviour
{
    public string name = "Solidified Prismarine";
    ...
    private void OnTriggerEnter2D(Collider2D other)
    {
        ...
        if (itemBehaviour.name != "Rock" && itemBehaviour.name != "Iron" && itemBehaviour.name != "Prismarine")
        {
    ...
    IEnumerator StartTheTimerTicker()
    {
        while (true)
        {
            ...
            ; if (ironNumber >= 1 && prismarineNumber >= 1 && rockNumber >= 1)
            {
